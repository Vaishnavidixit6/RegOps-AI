...
def setup_telemetry() -> str | None:
    ...
    if bucket and capture_content != "false":
        ...
        os.environ.setdefault(
            ...
            f"service.namespace=regulatory-agent,service.version={commit_sha}",
        )
    ...
    try:
        ...
        logging.warning(f"Could not initialize Cloud Trace/Logging exporters: {e}. Continuing with local execution.")
